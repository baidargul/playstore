      ...
      <div className="flex justify-between">
          ...
          <div className="flex justify-between w-[40%] my-5">
            <div className="flex flex-col gap-1 items-center">
              <div className="flex items-center gap-1">
                ...
                <div>
                  <img src="/star.svg" className="text-black w-3 h-3" />
                </div>
              </div>
              <div className="text-xs  font-medium">2.18M reviews</div>
            </div>
            ...
            <div className="flex flex-col gap-1 items-center">
              <div className="flex items-center gap-1">
                ...
                <div>
                  <img src="/star.svg" className="text-black w-3 h-3 hidden" />
                </div>
              </div>
            ...
            <div className="flex flex-col gap-2 items-center">
              <div className="flex items-center gap-1">
                ...
                <div>
                  <img src="/3+.png" className="text-black w-4 h-4" />
                </div>
              </div>
              <div className="text-xs font-medium">Rated for 3+</div>
            </div>
          </div>
        ...
        <div className="relative flex justify-center">
          <img
            src="/AppLogo.jpg"
            alt="adobe"
            className="min-w-60 h-60 rounded-[50px] z-[1] object-cover"
          />
          <img
            src="/AppLogo.jpg"
            alt="adobe"
            className="min-w-56 h-56 rounded-[50px] absolute bottom-[80px] blur-md opacity-50 object-cover"
          />
        </div>
      </div>
